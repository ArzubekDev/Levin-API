        ...
        <Card className="mb-6 border-slate-800 bg-slate-900">
          ...
          <CardContent>
            <div className="flex items-center gap-2">
              <code className="flex-1 overflow-x-auto rounded-lg bg-slate-950 p-3 font-mono text-sm text-green-400">
                {apiUrl}
              </code>
              <Button
                variant="outline"
          ...
          {resources.map((resource) => (
            <TabsContent key={resource} value={resource}>
              <Card className="border-slate-800 bg-slate-900">
                ...
                <CardContent>
                  {testResponse && (
                    <pre className="overflow-x-auto rounded-lg bg-slate-950 p-4 font-mono text-sm text-slate-300">
                      {testResponse}
                    </pre>
                  )}
                </CardContent>
